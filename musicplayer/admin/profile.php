        ...
        else if ($action == 'change_pw') 
        {
            ...
            if ($old_pw_change && $new_pw_change && $re_new_pw_change) {
                ...
                // Kiểm tra mật khẩu mới    
                    ...
                    echo $show_alert.'Mật khẩu mới phải lớn hơn hoặc bằng 6 ký tự.';
