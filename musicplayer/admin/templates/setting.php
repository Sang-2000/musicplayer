<?php
    ...
    if ($user)
    {
        ...
        else if ($data_user['position'] == 1)
        {
            ...
            if ($db->db_num_rows($sql_get_stt_web)) {
                $data_web = $db->db_fetch_assoc($sql_get_stt_web, 1);
            ...
            if ($db->db_num_rows($sqlGetInfoWeb)) {
                $data_web = $db->db_fetch_assoc($sqlGetInfoWeb, 1);
            }
